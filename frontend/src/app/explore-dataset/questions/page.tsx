  ...
  return (
    <section className="flex flex-col gap-15">
      <p className="text-sm text-gray-600 max-w-3xl">
        ...
        specific keywords, such as construct names or item wordings, or
        browse the overview of questions below. By clicking on an item, you
        can see detailed information, including when it was measured.
        Selecting multiple items, allows you to see when all selected items
        (&ldquo;AND&rdquo;), or at least one of them (&ldquo;OR&rdquo;), were
        measured.
      </p>
