  ...
  return (
    <section className="flex flex-col gap-15">
      <p className="text-sm text-gray-600 max-w-233  -mb-4">
        ...
        detailed information, including when it was measured. Selecting multiple
        items, allows you to see when all selected items (&ldquo;AND&rdquo;), or
        at least one of them (&ldquo;OR&rdquo;), were measured.
      </p>
